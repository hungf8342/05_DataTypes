...
Even when the outlier is removed, ACR is still very skewed. This will be an important consideration in analyses, such as the need to transform or categorize this variable.
...
Boxplots are another useful graphical summary for displaying common summary statistics of a variable: the median, the 25th percentile, and the 75th percentile. The distance between the 25th and 75th percentile is called the interquartile range, and any data points outside of 1.5 times the interquartile range are plotted individually to highlight their separation from the bulk of the data values.
...
Violin plots provide the same information as a boxplot, except the box is replaced with estimated density of the data.
...
Below are violin plots for several variables from the NHANES data stratified by sex.
...
In an earlier video in our course, we discussed using scatterplots for exploring relationships between two quantitative variables.
