...
- Qualitative data are those that can be grouped into classes or categories and have multiple subtypes, including binary, nominal, or continuous. 
...
In an earlier video in our course, we discussed scatterplots for exploring relationships between two quantitative variables.
